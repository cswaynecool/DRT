...
class BaseConvolutionLayer : public Layer<Dtype> {
 public:
   ...
   float* d_in_response;
   float2* d_freq_response;

   cufftHandle forward_plan_response[1]; 
   cufftHandle inverse_plan_response[1];
   ...
   float* d_in_sub_total1;
   float2* d_freq_sub_total1;
   float* d_in_sub_total2;
   float2* d_freq_sub_total2;

   float* d_in_total1;
   float2* d_freq_total1;
   float* d_in_total2;
   float2* d_freq_total2;
   float* d_in_total3;
   float2* d_freq_total3;
   float* d_in_total4;
   float2* d_freq_total4;
   float* d_in_total5;
   float2* d_freq_total5;

   cufftHandle forward_plan[5]; 
   cufftHandle inverse_plan[5]; 

   cufftHandle forward_plan_sub_total[5]; 
   cufftHandle inverse_plan_sub_total[5];  

   cufftHandle forward_plan_total[5]; 
   cufftHandle inverse_plan_total[5];  
