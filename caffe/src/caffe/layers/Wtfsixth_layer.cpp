...
void WtfsixthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtfsixthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WtfsixthLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WtfsixthLayer);
#endif

INSTANTIATE_CLASS(WtfsixthLayer);
