...
params.init_max_CG_iter = 20;          % The number of Conjugate Gradient iterations used in the first frame
...
params.CG_forgetting_rate = 70;         % Forgetting rate of the last conjugate direction
