...
void WtfeighthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtfeighthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WtfeighthLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WtfeighthLayer);
#endif

INSTANTIATE_CLASS(WtfeighthLayer);
