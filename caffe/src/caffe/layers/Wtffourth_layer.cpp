...
void WtffourthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtffourthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
#ifdef CPU_ONLY
STUB_GPU(WtffourthLayer);
#endif

INSTANTIATE_CLASS(WtffourthLayer);
