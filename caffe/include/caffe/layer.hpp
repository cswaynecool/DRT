...
static vector<shared_ptr<Blob<Dtype> > > second_layer_hf_real_patch;
static vector<shared_ptr<Blob<Dtype> > > second_layer_hf_imag_patch;
...
static vector<shared_ptr<Blob<Dtype> > > reliability_response;
static vector<shared_ptr<Blob<Dtype> > > reliability_response1;
static vector<shared_ptr<Blob<Dtype> > > reliability_response2;
static vector<shared_ptr<Blob<Dtype> > > hf1;
...
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_hf_real_patch;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_hf_imag_patch;
...
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::reliability_response;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::reliability_response1;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::reliability_response2;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::hf1;
