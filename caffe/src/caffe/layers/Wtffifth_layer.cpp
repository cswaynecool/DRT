...
void WtffifthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtffifthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WtffifthLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WtffifthLayer);
#endif

INSTANTIATE_CLASS(WtffifthLayer);
