...
void WtfninthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtfninthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WtfninthLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WtfninthLayer);
#endif

INSTANTIATE_CLASS(WtfninthLayer);
